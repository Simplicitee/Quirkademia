...
public class HardeningQuirk extends Quirk {
	...
	public Set<QuirkAbilityInfo> registerAbilities() {
		...
		register.add(new QuirkAbilityInfo(ActivationType.PASSIVE, Hardening.class, this, "Hardening", "Keeps track of your hardness while hardened and recharging!", "Passively active"));
